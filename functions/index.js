...
exports.handler = async (context, event, callback) => {
  ...
  if (CurrentConfidencevalue === 1 || CurrentConfidencevalue === 0) {
    switch (CurrentTask) {
      case "Address":
        console.log("Address");
        await AddressTaskHandler.Address_task(
          context,
          event,
          callback,
          responseBuilder.RB
      ...
      case "payment":
        console.log("payment");
        await paymentTaskHandler.payment_task(
          context,
          event,
          callback,
          responseBuilder.RB
      ...
      case "Agent":
        console.log("Agent");
        await AgentTransferTypeHandler.agent_transfer_task(
          context,
          event,
          callback,
          responseBuilder.RB
      ...
      case "goodbye":
        await goodbyeTaskHandler.goodbye_task(
          context,
          event,
          callback,
          responseBuilder.RB
